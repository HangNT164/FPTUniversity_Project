...
//                            String readPart = getServletContext().getRe?alPath("/");
                ...
                System.out.println("aaaaaaaaaaaaaaaaaaaabbbbbbbbbba");
                ...
                for (Image image : list2) {
                    if (image.getProductId() == id) {
                        new ImageDao().deleteKHAC(image.getId());
                    }
                }
                ...
                boolean b = new ImageDao().addlistImg(images);
