...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <!-- Title -->
        <title>MAC Cosmetics | VIỆT NAM | New Password</title>
        <!-- Font Awesome -->
                            ...
                            <div class="col-md-6 col-xl-5 mb-4">
                                ...
                                <div class="card wow fadeInRight" data-wow-delay="0.3s" style="visibility: visible; animation-name: fadeInRight; animation-delay: 0.3s;">
                                    <div class="card-body">
                                        ...
                                        <!--Body-->
                                        <form action="new-password"method="post"id ="loginForm">                                         
                                            <div class="md-form">
                                            ...
                                            <div class="md-form">
                                                <i class="fas fa-key prefix white-text"></i>
                                                <input type="password" class="white-text form-control"name="confirm"
