                                ...
                                <c:otherwise>
                                    ...
                                    <div class="container" style="background-color:whitesmoke;"><br />
                                        ...
                                        <c:forEach items="${listCardProcess}" var="product" varStatus="i">   
                                            <div class="row">
                                                ...
                                                <div class="col-xl-2 col-lg-2 col-md-2">
                                                    ...
                                                    <p style="text-align: center;">          
                                                        ${product.customerInofr}
                                                    </p>
                                                </div>

                                                <div class="col-xl-2 col-lg-2 col-md-2">
                                                    <p style="text-align: center;padding-top:25px;">
                                                        <c:set var = "totalPriceVi" scope = "session" value = "${product.total}"/>
                                                        ...
                                                        <c:if test="${language eq 'en_US'}">
                                                            <c:set var = "totalPriceEn" scope = "session" value = "${Math.round(totalPriceVi/23)}"/>
                                                            <fmt:formatNumber type="currency" maxFractionDigits="0" 
                                                                              value="${totalPriceEn}"/>
                                                        </c:if>  

                                                        <c:if test="${language eq 'ja_JP'}">
                                                            <c:set var = "totalPriceJP" scope = "session" value = "${Math.round(totalPriceVi/22)}"/>
                                                            <fmt:formatNumber type="currency" maxFractionDigits="0" 
                                                                              value="${totalPriceJP}"/>
                                                        </c:if>  
                                            ...
                                            <span style="display:none">
                                                ${totalPriceAll=totalPriceAll+product.total}
                                            </span>
                                        </c:forEach>
                                    </div>
                                    <!-- /.Gio Hang -->
                                    ...
                                    <div class="container">      
                                        <p style="text-align: right;">
                                            ...
                                            <c:if test="${language eq 'ja_JP'}">
                                                <c:set var = "numberTotal" scope = "session" value = "${Math.round(totalPriceAll/22)}"/>
                                                <fmt:formatNumber type="currency" maxFractionDigits="0" 
                                                                  value="${numberTotal}"/>
                                            </c:if>  
                                        </p>
