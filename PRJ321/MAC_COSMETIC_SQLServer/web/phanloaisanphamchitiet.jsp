...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin-top:8%;">
                                ...
                                <div class="product-grid">
                                    <div class="product-image">                
                                        <div class="image-box"style="height:300px;">
                                            <a href="product-detail?id=${product.id}">
                                                <img class="card-img-top" 
                                                     src="${listImageTrue.get(loop.count-1)}
                                        ...
                                        <ul class="social">
                                            ...
                                            <li>
                                                <a href="add-card?id=${product.id}&flag=5"
            ...
            <!-- Next  -->
            <%String subIDStr = String.valueOf(request.getAttribute("subID"));%>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    <c:forEach items="${listPage}" var="page">  
                        <li class="page-item">
                            <a class="page-link"
                               href="filter-product-detail?pageId=${page}&subID=<%=subIDStr%>&language=${language}">${page}</a>
                        </li>
                    </c:forEach>
                    <li class="page-item">
