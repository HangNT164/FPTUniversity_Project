 ...
 * @author HangNT
 */
@WebServlet(name = "NewServlet", urlPatterns = {"/get-all-product"})
public class GetAllProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            List<Product> listProduct = new ProductService().getAllNewProduct();
            ...
            if (pageID <= 0) {
                ...
                listProductInAPage
                        = new ProductService().getListProductNew(pageID, 12);
