        ...
        <div class="container" style="margin-top:2%;">
                                ...
                                <div class="modal-body">
                                    <div class="card" style="background-color: white;">
                                        ...
                                        <div class="row"style="margin-left:10%;">
                                            ...
                                            </a> <a href="add-card?id=${product.id}&flag=1"> 
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item" >
                        <a class="page-link" href="hot-product?pageId=<%=link%>&language=${language}">Previous</a>
                    </li>
                    <%} else {%>
                    ...
                    <c:forEach items="${listPage}" var="page">    
                        <li class="page-item">
                            <a class="page-link"href="hot-product?pageId=${page}&language=${language}">${page}</a>
                        </li>
                    </c:forEach>
                    <%String link1 = String.valueOf(request.getAttribute("linkPage1"));%>

                    <li class="page-item" >
                        <a class="page-link" href="hot-product?pageId=<%=link1%>&language=${language}">Next</a>
                    </li>
                </ul>
            </nav>
        </div>
