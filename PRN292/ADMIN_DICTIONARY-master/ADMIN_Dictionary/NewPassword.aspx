<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewPassword.aspx.cs" Inherits="ADMIN_Dictionary.NewPassword" %>
            ...
            <div class="login-panel">
                ...
                <form id="form1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" placeholder="New Password" id="TxtNewPassword" runat="server" required />
                    </div>
                    <div class="form-group">
                        <label>
                            <i class="fas fa-user fa-fw"></i>
                        </label>
                        <input type="password" class="form-control" placeholder="Confirm Password" id="txtConfirmPass" runat="server" required />
                    </div>
                    <br>
                    <div class="form-group">
                        <div class="col">
                            <button runat="server" onserverclick="txtConfirm_New_Click" class="btn btn-sm">
                                <i class="fas fa-sign-in-alt fa-fw mr-1"></i>Save
