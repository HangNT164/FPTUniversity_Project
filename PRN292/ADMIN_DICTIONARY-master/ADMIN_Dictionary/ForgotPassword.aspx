<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="ADMIN_Dictionary.ForgotPassword" %>
            ...
            <div class="login-panel">
                ...
                <form id="form1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" placeholder="Email" ID="TxtEmail" runat="server" required />
                    </div>

                    <br>
                    <div class="form-group">
                        <div class="col">
                          <button runat="server" onserverclick="txtSend_Click" class="btn btn-sm">
