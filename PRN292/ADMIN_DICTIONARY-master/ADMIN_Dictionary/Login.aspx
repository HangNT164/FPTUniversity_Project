<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ADMIN_Dictionary.Login" %>
            ...
            <div class="login-panel">
                ...
                <form id="form1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Username" id="txtUsername" runat="server"   required />
                    </div>
                    <div class="form-group">
                        <label>
                                <i class="fas fa-key fa-fw"></i>
                            </label>
                        <input type="password" class="form-control" placeholder="Password" id="txtPassword" runat="server"  required />
                    </div>
                    <br>
                    <div class="form-group">
                        <div class="col">
                           <button runat="server" onserverclick="LoginSubmit" class="btn btn-sm">
                    ...
                    <div class="form-group">
                        <div class="col">
                            ...
                            <a class="link-effect float-right" href="ForgotPassword.aspx">
