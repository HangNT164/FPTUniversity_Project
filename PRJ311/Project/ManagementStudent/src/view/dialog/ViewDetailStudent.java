...
public class ViewDetailStudent extends javax.swing.JDialog {
    ...
    private void updateGui(Locale locale) {
        ...
        labelLoginAccount12.setText(address);
    ...
    public ViewDetailStudent(java.awt.Frame parent, boolean modal, Student student, String username, Locale locale) {
        super(parent, modal);
        initComponents();
        this.locale = locale;
    ...
    private void initComponents() {
        ...
        kGradientPanel4.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 470, 380, 190));
        ...
        labelLoginAccount12.setText("Address:");
        kGradientPanel4.add(labelLoginAccount12, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 470, 110, 30));
